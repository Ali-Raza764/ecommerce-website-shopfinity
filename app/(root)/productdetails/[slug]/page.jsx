  ...
  return (
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="px-4 py-8">
        <div className="w-full flex lg:flex-row flex-col lg:gap-3">

          <div className="lg:w-1/2 w-full images flex justify-center items-center gap-3 flex-wrap-reverse md:flex-nowrap">
            <div className="available_images md:h-[25rem] lg:w-full flex md:flex-col items-center justify-center gap-2 overflow-auto overflowed-product-images">
              <Image src="https://dummyimage.com/100x100" height={100} width={100} />
              <Image src="https://dummyimage.com/100x100" height={100} width={100} />
              <Image src="https://dummyimage.com/100x100" height={100} width={100} />
              <Image src="https://dummyimage.com/100x100" height={100} width={100} />
              <Image src="https://dummyimage.com/100x100" height={100} width={100} />
