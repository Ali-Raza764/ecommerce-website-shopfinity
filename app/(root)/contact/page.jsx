...
const Contact = () => {
  return (
    <div className="w-full min-h-screen flex py-[5rem] px-11 gap-8">
      <div className="w-1/3 flex flex-col itms-center gap-5 shadow p-4">
        <div className="call">
      ...
      <div className="w-2/3 flex flex-col itms-center shadow shadow-gray-300 rounded-md p-4">
        <ContactForm />
      </div>
    </div>
  );
